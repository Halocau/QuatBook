<%-- 
    ...
    Created on : Mar 6, 2024, 7:31:44 PM
    Author     : Admin
--%>
...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>Shop bán sách của Quát</title>
    ...
    <body class="product-details">
        ...
        <header>
            ...
            <jsp:include page="../common/comonHome/header-top-area.jsp"></jsp:include>
                <!-- header-top-area-end -->
                <!-- header-mid-area-start -->
            <jsp:include page="../common/comonHome/header-mid-area.jsp"></jsp:include>
                <!-- header-mid-area-end -->
                <!-- main-menu-area-start -->
            <jsp:include page="../common/comonHome/main-menu-area.jsp"></jsp:include>
                <!-- main-menu-area-end -->
                <!-- mobile-menu-area-start -->
            <jsp:include page="../common/comonHome/mobile-menu-area.jsp"></jsp:include>
                <!-- mobile-menu-area-end -->
            </header>
            <!-- header-area-end -->
            <!-- breadcrumbs-area-start -->
        <jsp:include page="../common/comonHome/breadcrumbs-area.jsp"></jsp:include>
                                    ...
                                    <div class="col-lg-5 col-md-6 col-12">
                                        <div class="flexslider">
                                            <ul class="slides">
                                                ...
                                                <img src="${productFindId.image}" alt="woman" />
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="product-info-main">
                                        ...
                                        <div class="product-info-price">
                                            <div class="price-final">
                                                <span>$${productFindId.price}</span>                                              
                                            </div>
                                        </div>
                                        <div class="product-add-form">
                                            <form action="cart?action=add-product" method="POST">
                                                <input type="hidden" name="id" value="${productFindId.id}"/>

                                                <div class="quality-button">
                                                    <input class="qty" type="number" name="quantity" value="1" min="1"
                                                           max="${productFindId.quantity}"
                                                           onchange="if (this.value.trim() === '' || parseInt(this.value) > parseInt(this.getAttribute('max')))
                                                                     window.location.reload();"> 
                                                </div>
                                                <a href="#" onclick="if(${productFindId.quantity == 0}) { window.location.reload(); } else { return this.closest('form').submit(); }">Add to cart</a>
                                            </form>
                                        </div>
                                        ...
                                        <c:if test="${productFindId.quantity != 0}">
                                            <h6 style="color: red">(Remaining: ${productFindId.quantity})</h6>
                                        </c:if>
                                        <c:if test="${productFindId.quantity == 0}">
            ...
            <!-- product-main-area-end -->
            <!-- footer-area-start -->
            <jsp:include page="../common/comonHome/footer.jsp"></jsp:include>
                <!-- footer-area-end -->
                <!-- Modal -->
