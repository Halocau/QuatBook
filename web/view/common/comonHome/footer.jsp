<%-- 
    Document   : footer
    Created on : Mar 5, 2024, 8:32:23 PM
    Author     : Admin
--%>
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="single-footer br-2 xs-mb">
                                ...
                                <div class="footer-mid-menu">
                                    <ul>
                                        <li><a href="https://www.facebook.com/quat.buitien">About us</a></li>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="single-footer mrg-sm">
                        ...
                        <div class="footer-contact">
                            ...
                            <p><span>Call us now:</span> 0879219888</p>
                            <p><span>Email:</span> buitienquat2k3@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
