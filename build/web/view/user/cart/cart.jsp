<%-- 
    Document   : cart
    Created on : Mar 11, 2024, 5:35:11 AM
    Author     : Admin
--%>
...
<html class="no-js" lang="en">
    ...
    <body class="cart">
        ...
        <header>
            ...
            <jsp:include page="../../common/commonUserCart/header-top-area.jsp"></jsp:include>
                <!-- header-top-area-end -->
                <!-- header-mid-area-start -->
            <jsp:include page="../../common/commonUserCart/header-mid-area.jsp"></jsp:include>
                <!-- header-mid-area-end -->
                <!-- main-menu-area-start -->
            <jsp:include page="../../common/commonUserCart/main-menu-area.jsp"></jsp:include>
                <!-- main-menu-area-end -->
                <!-- mobile-menu-area-start -->
            <jsp:include page="../../common/commonUserCart/mobile-menu-area.jsp"></jsp:include>
                <!-- mobile-menu-area-end -->
            </header>
            <!-- header-area-end -->
            <!-- breadcrumbs-area-start -->
        <jsp:include page="../../common/commonUserCart/breadcrumbs-area.jsp"></jsp:include>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="table-content table-responsive mb-15 border-1">
                                <table>
                                    ...
                                    <c:forEach items="${cart.listOrderDetail}" var="order">
                                        ...
                                        <tr>
                                            ...
                                            <td class="product-subtotal">${product.price * order.quantity}</td>
        ...
        <!-- cart-main-area-end -->
        <!-- footer-area-start -->
        <jsp:include page="../../common/commonUserCart/footer.jsp"></jsp:include>
            <!-- footer-area-end -->
