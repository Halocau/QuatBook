<%-- 
    Document   : home
    Created on : Mar 5, 2024, 7:36:38 PM
    Author     : Admin
--%>
...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>QuatBook - Shop bán sách của Quát</title>
                ...
                <div class="container">
                            ...
                            <div class="shop-left">
                                ...
                                <div class="left-menu mb-30">
                                    ...
                                    <c:forEach items="${listCategory}" var="ca">
                                        <li><a href="home?action=category&categoryId=${ca.id}">${ca.name}<span>(15)</span></a></li>
                                        </c:forEach>
                    ...
                    <div class="col-lg-9 col-md-12 col-12 order-lg-2 order-1">
                        <div class="category-image mb-30">
                            <a href="#"><img src="${pageContext.request.contextPath}/img/banner/vip1.png" alt="banner" /></a>
                        </div>
                        <div class="section-title-5 mb-30">
                            <h2>Book</h2>
                        </div>
...
<!--                                                        <img src="${pageContext.request.contextPath}/img/product/14.jpg" alt="book" class="primary" />-->
                                                ...
                                                <div class="product-details text-center">
                                                    <h4><a href="productdetail?id=${p.id}">${p.name}</a></h4>
                                                    <div class="product-price">
                                                        <ul>
                                                            <li>$${p.price}</li>
                                                        </ul>
                                                ...
                                                <div class="product-link">
                                                    ...
                                                    <div class="product-button">
                                                        <a href="productdetail?id=${p.id}" onclick="return this.closest('form').submit()"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                                    </div>

                                                    <div class="add-to-link">
                                                        <ul>
                                                            <li><a href="productdetail?id=${p.id}" title="Details"><i class="fa fa-external-link"></i></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
